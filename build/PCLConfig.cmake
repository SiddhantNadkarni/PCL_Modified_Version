...
macro(find_flann)
  ...
  elseif(NOT FLANN_ROOT)
    get_filename_component(FLANN_ROOT "" PATH)
  endif(PCL_ALL_IN_ONE_INSTALLER)
...
macro(find_VTK)
  ...
  elseif(NOT VTK_DIR AND NOT ANDROID)
    set(VTK_DIR "/usr/local/lib/cmake/vtk-8.2" CACHE PATH "The directory containing VTKConfig.cmake")
...
elseif(EXISTS "${PCL_DIR}/include/pcl/pcl_config.h")
  ...
  set(PCL_SOURCES_TREE "/home/siddhantnadkarni/Libraries/pcl-pcl-1.9.1")
